    ...
    <>
      <div className="w-full md:px-20 ss:px-[12rem] md:mt-0 lg:mt-12">
        <Hero
          ...
          description="Dedicados a impulsionar o seu negócio para novos patamares de sucesso digital. Com uma sólida trajetória, abraçamos desafios com entusiasmo, sempre comprometidos em entregar resultados excepcionais que superem as expectativas dos nossos clientes."
